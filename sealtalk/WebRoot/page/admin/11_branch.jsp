...
<div class="modal-body">
	...
	<div class='h40px'></div>
	<div>
		<div class='dialogtitle' style='padding-right: 120px; margin-left: 10px'><span style='color:red'>*</span>上级部门：
			<input class='treeedit2 xiala toright' id='xiala12' readonly></input>
			<input type='text' id='11branchbranch' name='11branchbranch' class='treeedit2 w252px toright' readonly>
	...
	<div>
		<div class='dialogtitle' style='margin-left: 10px'><span style='color:red'>*</span>部门名称：	
			<input type='text' id='11branchname' name='11branchname' class='w270px toright rightspace120'>
		</div>
	</div>
	<div class='linespace'></div>
	<div>
		<div class='dialogtitle' style='padding-right: 40px; margin-left: 10px'><span style='color:red'>*</span>部门领导：
			...
			<input type='text' id='11branchmanager' name='11branchmanager' class='treeedit2 w252px toright' readonly>
