            ...
            <div class="resetStep step1 ">
                ...
                <div name="formFogot" class="form-inline" step="resetStep-1">
                    <div class="">
                        ...
                        <input type="text" name="phone" ng-model="user.phone" required="" phone-registered="" ng-disabled="codeloading" class="phoneNum ng-pristine ng-untouched ng-valid-phoneformat ng-invalid ng-invalid-required" placeholder="手机号" my-focus="">
                    ...
                    <div class="" style="margin-top: 30px">
                        <div class="msgCode clearfix">
                            ...
                            <input type="text" name="code" ng-model="user.code" required="" class="msgCode ng-pristine ng-untouched ng-invalid ng-invalid-required" placeholder="短信验证码" my-focus="">
                    ...
                    <div class="button-wrapper form-group">
                        ...
                        <button class="sign-button step1Btn" class="nextfun" onclick="fToNext(this)">下一步</button>
                    </div>
                </div>
            </div>
                ...
                <div name="formResetPwd" class="form-inline" step="resetStep-2" novalidate="novalidate">
                    <div class="">
                        ...
                        <input type="password" name="newpassword" class=" pwd"
                               placeholder="新密码（密码由 6-16 个字符组成）">
                    ...
                    <div class="" style="margin-top: 30px">
                        ...
                        <input type="password" name="repassword"class=" repwd" placeholder="再次输入">
                    ...
                    <div class="button-wrapper form-group">
                        ...
                        <button class="sign-button step1Btn"  onclick="fToNext(this)">下一步</button>
                    </div>
                </div>
            </div>
